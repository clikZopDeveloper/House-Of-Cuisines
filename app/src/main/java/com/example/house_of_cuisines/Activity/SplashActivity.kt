...
import com.example.house_of_cuisines.databinding.ActivitySplashBinding
...
class SplashActivity : AppCompatActivity(), GoogleApiClient.OnConnectionFailedListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val animation4 = AnimationUtils.loadAnimation(this, com.example.house_of_cuisines.R.anim.zoom)
